...
function addMedia(type, media) {
    ...
    let data = {
        mId: Date.now(),
        type,
        media, // shorthand for media: media
    };
    ...
    req.addEventListener('success', function() {
        ...
        if(cursor)
        {
            ...
            deleteBtn.addEventListener('click', function(e) {
                ...
                e.currentTarget.parentElement.parentElement.remove(); // delete from UI
                deleteMediaFromDB(mId); // delete from DB
            });
